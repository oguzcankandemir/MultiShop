...
namespace MultiShop.Catalog.Services.ProductImageImageServices
{
    public class ProductImageService : IProductImageService
    {
        ...
        public ProductImageService(IMapper mapper, IDatabaseSettings _databaseSettings)
        {
            ...
            var datanbase = client.GetDatabase(_databaseSettings.DatabaseName);
            _ProductImageCollection = datanbase.GetCollection<ProductImage>(_databaseSettings.ProductImageCollectionName);
            _mapper = mapper;
        }
        public async Task CreateProductImageAsync(CreateImageProductDto createProductImageDto)
        {
